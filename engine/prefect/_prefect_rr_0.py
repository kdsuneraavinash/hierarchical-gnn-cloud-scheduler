...
def workflow():
    ...
    t5 = task_5.submit(wait_for=[t4])
    t6 = task_6.submit(wait_for=[t0, t5])
    t7 = task_7.submit(wait_for=[t1, t6])
    t8 = task_8.submit(wait_for=[t4, t7])
    t9 = task_9.submit(wait_for=[t8, t5])
    t10 = task_10.submit(wait_for=[t9, t6])
    t11 = task_11.submit(wait_for=[t10, t7])
    t12 = task_12.submit(wait_for=[t8, t11])
    t13 = task_13.submit(wait_for=[t9, t12])
    t17 = task_17.submit(wait_for=[t12])
    t14 = task_14.submit(wait_for=[t10, t13])
    t18 = task_18.submit(wait_for=[t17, t13])
    t19 = task_19.submit(wait_for=[t17])
    t15 = task_15.submit(wait_for=[t11, t14])
    t20 = task_20.submit(wait_for=[t19, t14])
    t16 = task_16.submit(wait_for=[t15])
    t21 = task_21.submit(wait_for=[t17, t15])
    t22 = task_22.submit(wait_for=[t16, t17])
    t23 = task_23.submit(wait_for=[t19, t22])
    t24 = task_24.submit(wait_for=[t18, t20, t21, t23])
    t25 = task_25.submit(wait_for=[t24, t23])
    t26 = task_26.submit(wait_for=[t25])
    t27 = task_27.submit(wait_for=[t24, t26])
    t28 = task_28.submit(wait_for=[t26])
    t29 = task_29.submit(wait_for=[t27, t28])
    t30 = task_30.submit(wait_for=[t28, t29])
    t31 = task_31.submit(wait_for=[t29, t30])
    t32 = task_32.submit(wait_for=[t30, t31])
    t35 = task_35.submit(wait_for=[t22, t31])
    t37 = task_37.submit(wait_for=[t31])
    t33 = task_33.submit(wait_for=[t32, t20])
    t36 = task_36.submit(wait_for=[t32, t35])
    t34 = task_34.submit(wait_for=[t33, t21])
    t38 = task_38.submit(wait_for=[t33, t37])
    t39 = task_39.submit(wait_for=[t34, t31])
    t40 = task_40.submit(wait_for=[t35, t39])
    t44 = task_44.submit(wait_for=[t39])
    t41 = task_41.submit(wait_for=[t40, t34, t36, t38])
    t42 = task_42.submit(wait_for=[t41, t37])
    t45 = task_45.submit(wait_for=[t41, t44])
    t43 = task_43.submit(wait_for=[t42, t38])
    t46 = task_46.submit(wait_for=[t42, t44])
    t48 = task_48.submit(wait_for=[t44, t45])
    t47 = task_47.submit(wait_for=[t43, t44])
    t49 = task_49.submit(wait_for=[t48, t45, t46, t47])
    t49.result()
