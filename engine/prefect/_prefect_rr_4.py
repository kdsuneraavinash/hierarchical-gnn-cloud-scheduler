...
def workflow():
    ...
    t5 = task_5.submit(wait_for=[t1, t4])
    t7 = task_7.submit(wait_for=[t4])
    t6 = task_6.submit(wait_for=[t5])
    t8 = task_8.submit(wait_for=[t5, t7])
    t10 = task_10.submit(wait_for=[t7])
    ...
    t14 = task_14.submit(wait_for=[t11, t12, t13])
    t15 = task_15.submit(wait_for=[t12, t14])
    t17 = task_17.submit(wait_for=[t14])
    t16 = task_16.submit(wait_for=[t13, t15])
    t18 = task_18.submit(wait_for=[t17, t15])
    t19 = task_19.submit(wait_for=[t17])
    t20 = task_20.submit(wait_for=[t16, t18, t19])
    t21 = task_21.submit(wait_for=[t19])
    t22 = task_22.submit(wait_for=[t20, t21])
    t23 = task_23.submit(wait_for=[t21])
    t24 = task_24.submit(wait_for=[t21, t23])
    t25 = task_25.submit(wait_for=[t24, t18, t22, t23])
    t26 = task_26.submit(wait_for=[t25, t22])
    t28 = task_28.submit(wait_for=[t25])
    t27 = task_27.submit(wait_for=[t24, t26])
    t29 = task_29.submit(wait_for=[t26, t28])
    t30 = task_30.submit(wait_for=[t27, t28])
    t34 = task_34.submit(wait_for=[t29])
    t31 = task_31.submit(wait_for=[t28, t30])
    t36 = task_36.submit(wait_for=[t34])
    t32 = task_32.submit(wait_for=[t28, t31])
    t40 = task_40.submit(wait_for=[t36])
    t33 = task_33.submit(wait_for=[t32, t28, t29, t30, t31])
    t35 = task_35.submit(wait_for=[t32, t34])
    t38 = task_38.submit(wait_for=[t33, t34])
    t37 = task_37.submit(wait_for=[t34, t35])
    t39 = task_39.submit(wait_for=[t35, t36, t37, t38])
    t41 = task_41.submit(wait_for=[t40, t39])
    t42 = task_42.submit(wait_for=[t41])
    t43 = task_43.submit(wait_for=[t42])
    t44 = task_44.submit(wait_for=[t43, t38])
    t45 = task_45.submit(wait_for=[t40, t43])
    t46 = task_46.submit(wait_for=[t43, t44, t45])
    t47 = task_47.submit(wait_for=[t44, t46])
